~(function(win){
	var htmls = '<input type="file" name="files" id="" class="imgFiles" style="display: none" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" multiple>'+
				'<div class="header">'+
				'    <span class="imgClick">'+
				'    </span>'+
	...
	ImgUploadeFiles.prototype = {
		...
		ready : function(){
			...
			this.imgcontent.innerHTML = '上传最多<b style="color:red">'+this.MAX+'</b>张'+'图片';
	...
	ImgFileupload.prototype.init =function() {
		...
		this.dom.innerHTML = 
							'    <img src="http://94.191.126.93:8888/group1/M00/00/00/rB4AC14zm2CAOLO7AAAhi1op4SQ952.gif" alt="" data-src="'+this.imgSrc +'" class="imsg">'+
							'    <i class="delImg">'+
							'        X'+
							'    </i>';
